...
function 
    ...
    if ~exist('axial_force','var')
        cd Y:\groupRPT1\MATLAB\
        run Y:\groupRPT1\MATLAB\Main.m; %Run Main.m instead
        return
    end
    ...
    %Files
    log_file = 'Y:\groupRPT1\\Log\\groupABC_LOG.TXT';
    shaft_file = 'Y:\groupRPT1\\SolidWorks\\Equations\\shaft.txt';
